...
export class ConvenientStoreDepositScreen extends Component {
    ...
    _onCashInDone(amount) {
        ...
        if (!staffExternalId) {
            console.error("[ConvenientStoreDeposit] missing employeeDetails.external_id");
            ...
            Promise.resolve().then(async () => {
                try {
                    ...
                    if (!ok) {
                        console.error("[ConvenientStoreDeposit] finalize not ok:", resp);
        ...
        this.state.summaryItems = [
            { label: "Deposit Type", value: "Convenient Store Sales" },
