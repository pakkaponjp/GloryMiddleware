...
export class CoffeeShopDepositScreen extends Component {
    ...
    _onCashInDone(amount) {
        ...
        console.log("[CoffeeShopDeposit] cash-in done, amount:", numericAmount);
    ...
    _onCancelCounting() {
        console.log("[CoffeeShopDeposit] cancel from LiveCashInScreen");
        this.props.onCancel?.();
    }
    ...
    _onSummaryDone(amountFromSummary) {
        ...
        console.log("[CoffeeShopDeposit] summary done, final amount:", amount);
