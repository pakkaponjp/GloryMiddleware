...

{
    ...
    'data': [
        ...
        'report/cash_withdrawal_report.xml',
        'report/cash_replenish_report.xml',
        'report/cash_exchange_report.xml',
        'report/shift_audit_report.xml',
        'report/daily_report_report.xml',
        'report/cash_collect_report.xml',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'gas_station_cash/static/src/js/deposit_with_amount_screen.js',
            ...
            'gas_station_cash/static/src/xml/deposit_with_amount_screen_templates.xml',
