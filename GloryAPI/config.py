...
class Config:
    ...
    FCC_OPERATION_TIMEOUT = int(os.environ.get("FCC_OPERATION_TIMEOUT", 180)) # for SOAP ops
    ...
    if FCC_MODE == "physical":
        ...
        FCC_SOAP_PORT      = 443
        FCC_SOAP_VERIFY    = False #os.environ.get('FCC_SOAP_VERIFY', '/usr/local/share/ca-certificates/fcc.crt')  # cert path or 'False' to disable verification
    else:
